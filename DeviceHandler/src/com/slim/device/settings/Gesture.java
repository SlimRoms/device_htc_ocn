...
public class Gesture extends PreferenceFragment implements
    ...
    public static final String KEY_SQUEEZE_FORCE = "squeeze_force";
    ...
    private PreferenceScreen reloadSettings() {
        ...
        mSqueezeForce = (SlimSeekBarPreferencev2) prefs.findPreference(KEY_SQUEEZE_FORCE);
        ...
        mPrefs.edit().putInt(KEY_SQUEEZE_FORCE, DEFAULT_SQUEEZE_FORCE).commit();
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableGestures) {
            ...
            mPrefs.edit()
                    .putInt(KEY_SQUEEZE_FORCE, DEFAULT_SQUEEZE_FORCE).commit();
            return true;
        }
        return false;
    }
    ...
    private void resetToDefault() {
        ...
        editor.putInt(KEY_SQUEEZE_FORCE, DEFAULT_SQUEEZE_FORCE);
        editor.commit();
        reloadSettings();
    }
